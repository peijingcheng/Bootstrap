            ...
            <el-card class="hr-card" v-for="(hr,index) in hrs" :key="index">
                ...
                <div class="userinfo-container">
                    ...
                    <div>用户状态:<el-switch
                            ...
                            inactive-text="禁用"
                            active-color="#13ce66"
                            inactive-text="#ff4949"></el-switch>
                    </div>
                    <div>用户角色:<el-tag type="success" style="margin-right: 5px"
                                      v-for="(role,indexj) in hr.roles" :key="indexj">{{role.nameZh}}</el-tag>
                        <el-popover
                                placement="bottom"
                                title="角色列表"
                                @show="showPop(hr)"
...
<script>
    ...
    export default{
        ...
        methods:{
            deleteHr(hr){
                this.$confirm('此操作将永久删除该['+hr.name+'], 是否继续?', '提示', {
